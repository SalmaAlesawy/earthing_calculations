...
abstract class ColorsPalette {
  static const Color backGroundColor = Color(0xFF091319);
  static const Color cardColor = Color(0xFF141E24);
  static const Color mainOrange = Color(0xFFE36705);
  static const Color buttonsOrange = Color(0xFFE53935);
